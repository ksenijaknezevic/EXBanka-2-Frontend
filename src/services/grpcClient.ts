 ...
 *
 * Production: base URL read at runtime from window.__APP_CONFIG__.API_BASE_URL
 * (generated by docker-entrypoint.sh from ENV — no rebuild required to change it).
 */
